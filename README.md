...
Use the [issue tracker](http://github.com/lelylan/lelylan-ng-api/issues) for bugs.
[Mail](mailto:touch@lelylan.com) or [Tweet](http://twitter.com/lelylan) us for any idea that can improve the project.


### Links

* [GIT Repository](http://github.com/lelylan/lelylan-ng-api)
* [Lelylan Resources Website](http://lelylan.github.com/lelylan-ng-api).
...
See [CHANGELOG](https://github.com/lelylan/lelylan-ng-api/blob/master/CHANGELOG.md)


## Copyright

Copyright (c) 2013 [Lelylan](http://lelylan.com).
See [LICENSE](https://github.com/lelylan/lelylan-ng-api/blob/master/LICENSE.md) for details.
